...
public class _02_Output {
    public static void main(String[] args) {
        //%d(deciaml integer) : 10진 정수 형식
        //%f(floating-point) : 부동 소수점 형식


        System.out.println("---------- 정수 ----------");
        System.out.printf("%d%n", 1); // 1
        System.out.printf("%d%n", 1, 2, 3); // 1 2 3
        System.out.printf("%d%n", 1234); //1234
        System.out.printf("%6d%n", 1234); // __1234 총 6자리 공간을 확보하고 나서 1234 출력 (__1234)
        System.out.printf("%06d%n", 1234); //001234 (총 6자리의 공간 확보 후 1234 출력 할때 빈 공간에는 0으로 채웁니다)
        ...
        System.out.printf("%-6d%n", 1234); //1234__(6자리의 공간을 확보하고 나서 왼쪽 정렬.1234 출력합니다)
        ...
        System.out.printf("%-6s%n", "Java"); // __Java(6자리 공간 확보하고 좌측 정렬)
        System.out.printf("%6.2s%n", "Java"); // ____Ja(6자리 공간 확보하고 우측 정렬해서 두 글자만  정렬)
        System.out.printf("%-6.2s%n", "Java"); // JA_____(6자리 공간 확보하고 좌측 정렬해서 두 글자만  정렬)


        System.out.println("---------- 응용#1 ----------");
        System.out.println("이름 영어 수학 평균");
        System.out.println("강백호 " + 90 + " " + 80 + " " + 85.0); // 강백호 90 80 85.0
        System.out.println("서태웅 " + 100 + " " + 100 + " " + 100.0); // 강백호 90 80 85.0
        System.out.println("채치수 " + 95 + " " + 100 + " " + 97.5); // 강백호 90 80 85.0

        System.out.println("---------- 응용#2 ----------");
        System.out.println("이름      영어   수학   평균");//공백이 6,3,3 칸으로 구분
        System.out.printf("%-6s %4d %4d %6.1f%n", "강백호", 90, 80, 85.0); // 강백호 90 80 85.0
        System.out.printf("%-6s %4d %4d %6.1f%n", "서태웅", 100, 100, 100.0); // 강백호 90 80 85.0
        System.out.printf("%-6s %4d %4d %6.1f%n", "채치수", 95, 100, 97.5); // 강백호 90 80 85.0
