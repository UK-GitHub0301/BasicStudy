...
public class _02_AnonymousClass2 {
    public static void main(String[] args) {
        ...
        HomeMadeBurger sisterMadBurger = getSisterMadeBurger();
        sisterMadBurger.cook();
        System.out.println("-----------------------------");
    }

    private static HomeMadeBurger getSisterMadeBurger() {
        return new HomeMadeBurger() {
            @Override
            public void cook() {
                System.out.println("집에서 만드는 여동생버거");
                System.out.println("재료 : 호트밀, 아보카도, 샐러드, 양상추, 어이언드레싱");
            }
        };
    }
